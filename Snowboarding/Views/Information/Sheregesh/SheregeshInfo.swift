...
class SheregeshInfo: UIView {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.totalLengthOfTracks.trailingAnchor.constraint(equalTo: self.trailingAnchor),
            
//
//            self.totalLengthOfTracks.bottomAnchor.constraint(equalTo: self.totalLengthOfTracks.bottomAnchor)
        ])
    }
