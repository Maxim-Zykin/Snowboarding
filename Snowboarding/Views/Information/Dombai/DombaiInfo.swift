...
class DombaiInfo: UIView {
    ...
    private let aboutResort = CustomLabel(text: "Горный курорт Домбай (Домбайская поляна) расположился на территории Карачаево-Черкесской республики, у подножия Главного хребта Кавказских гор. Домбай - это не просто популярный горнолыжный курорт России, но и уникальный заповедник, который посещают туристы со всего мира. Домбай относится к всесезонному туристическому комплексу: с декабря по апрель создаются идеальные условия для активного катания по склонам, май - август - время для пешего туризма, ранняя осень - “бархатный” сезон, и только октябрь и ноябрь - сезон затишья.",  textAlignment: .left, size: 20, color: .black, numberOfLines: 20)
    
    private let allTracks = CustomLabel(text: "Всего трасс: 9", textAlignment: .left, size: 20, color: .black)
    private let heightDifference = CustomLabel(text: "Перепад высот: 1538 м", textAlignment: .left, size: 20, color: .black)
    private let totalLengthOfTracks = CustomLabel(text: "Общая длина трасс: 16,2 км", textAlignment: .left, size: 20, color: .black)
