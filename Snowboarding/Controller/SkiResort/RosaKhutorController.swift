...
class RosaKhutorController: UIViewController {
    ...
    private func setupUI() {
        ...
        self.scrollView.addSubview(rosaKhutorInfo)
        ...
        NSLayoutConstraint.activate ([
            ...
            self.rosaKhutorInfo.topAnchor.constraint(equalTo: self.segmentCo.bottomAnchor),
            self.rosaKhutorInfo.centerXAnchor.constraint(equalTo: self.contentView.centerXAnchor),
            self.rosaKhutorInfo.widthAnchor.constraint(equalTo: self.contentView.widthAnchor),
            
            self.weather.topAnchor.constraint(equalTo: self.rosaKhutorInfo.bottomAnchor, constant: 10),
