...
class ArhyzPriceController: UIViewController {

    let costModel = ArhyzPriceGroup.skiShow()
...
extension ArhyzPriceController: UITableViewDataSource {
