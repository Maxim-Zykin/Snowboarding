//
//  RosaKhutorPriceController.swift
//  Snowboarding
//
...
class RosaKhutorPriceController: UIViewController {

    let costModel = RosaKhutorPriceGroup.skiShow()
...
extension RosaKhutorPriceController: UITableViewDataSource {
