//
//  DombaiTimeWorkController.swift
//  Snowboarding
//
...
class DombaiTimeWorkController: UIViewController {

    let timeWorkModel = DombaiTimeWorkGroup.skiShow()
...
extension DombaiTimeWorkController: UITableViewDataSource {
