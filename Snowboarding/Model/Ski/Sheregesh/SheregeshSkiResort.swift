...
let sheregeshInfo = ModelSkiResort(
    nameSkiResot: "ШЕРЕГЕШ",
    allTracks: "16",
    ...
    costModel: priceSheregesh,
    hotelModel: hotelsSheregesh,
    rentsModel: rentsSheregeshAll,
    latitudeMap: 52.95282,
    longitudeMap: 87.954984)
